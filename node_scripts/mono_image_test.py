...
class MonoImage(object):
    ...
    def image_cb(self, img_msg):
        ...
        print(img_msg.format)
        print(img_in_cv2.shape)
        cv2.imwrite("mono_image.jpg", img_in_cv2)
...
if __name__ == "__main__":
    ...
    input_topic_img = "/kinect_head/rgb/image_rect_mono/compressed"
    output_topic_img = "/kinect_head/rgb/image_rect_color/compressed/gray"

    gs = MonoImage(input_topic_img, output_topic_img)
    rospy.spin()
